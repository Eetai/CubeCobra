...
const MobileView: React.FC<{
...
}> = ({ cubes, user, posts, lastKey, decks, lastDeckKey, featured, dailyP1P1 }) => (
  <Flexbox direction="col" gap="2">
    ...
    {!user?.hideFeatured && featured.length > 0 && (
      <CubesCard
...
}> = ({ cubes, user, posts, lastKey, decks, lastDeckKey, content, featured, dailyP1P1 }) => (
  <Row className="my-2">
    <Col xs={12} md={6} xl={7}>
      <Flexbox direction="col" gap="2">
        <Card>
